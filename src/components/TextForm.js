  ...
  return (
    <>
      <div className='container' style={{color : props.mode === 'light' ? 'black' : 'white'}}>
          <h1 style={{marginTop : '8px'}}>{props.heading}</h1>
          <div className="my-2">
          ...
          <button className="btn btn-primary my-1 me-2" onClick={handleCopytext} >Copy Text</button>
          <button className="btn btn-primary my-1 me-2" onClick={handleUpClick} >Convert to Uppercase</button>
          <button className="btn btn-primary my-1 me-2" onClick={handleLowClick} >Convert to Lowercase</button>
          <button className="btn btn-primary my-1 me-2" onClick={handleclrtext} >Clear Text</button>
      </div>
      <div className="container mt-1" style={{color : props.mode === 'light' ? 'black' : 'white'}}>
          ...
          <p>Average Read time: <strong>{0.005 *wordCount}</strong> minutes</p>
          <h2>preview</h2>
